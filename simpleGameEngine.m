...
classdef simpleGameEngine < handle
    ...
    methods
        function obj = simpleGameEngine(sprites_fname, sprite_height, sprite_width, zoom, background_color)
            ...
            %nargin is to detect how many formal arguments are input
            if nargin > 4
            ...
            %～ means do not output that value in that position
            ...
            % and image size
            % Built-in function, size, return [row, line]
            ...
            if isempty(transparency)
                %uint8 is to handle the 255 bits picture
